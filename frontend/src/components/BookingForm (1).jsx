...
// Accent color for primary action (match your logo red).
// Update this hex if you want an exact match.
const ACCENT = '#C62828'
...
// Simple inline SVG flags so they always render (no emoji dependency)
function Flag({code}){
