  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      <header className="flex justify-between items-center">
        ...
        <a href="/" className="text-sm link">Back to site</a>
      </header>
      ...
      <div className="card space-y-3">
        ...
        <p className="text-xs text-gray-400">Manage bookings and issue deposit refunds. Toggle which shades and slots are available.</p>
      </div>

      <div className="card overflow-auto">
        <h2 className="text-lg font-semibold text-accent mb-3">Bookings</h2>
        <table className="min-w-full text-sm">
          <thead><tr className="text-left">
            <th className="p-2">Date</th><th className="p-2">Time</th><th className="p-2">Name</th><th className="p-2">Email</th><th className="p-2">Quality/Shade</th><th className="p-2">Windows</th><th className="p-2">Total/Deposit</th><th className="p-2">Status</th><th className="p-2">Actions</th>
          </tr></thead>
          <tbody>
            {bookings.map(b => (
              <tr key={b.id} className="border-t border-accent/20">
                ...
                <td className="p-2">€{(b.amount_total/100).toFixed(2)} / €{(b.amount_deposit/100).toFixed(2)}</td>
            ...
            {bookings.length === 0 && (<tr><td className="p-2" colSpan="9">No bookings yet.</td></tr>)}
          </tbody>
        </table>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="card">
          <h2 className="text-lg font-semibold text-accent mb-3">Shades Availability</h2>
        ...
        <div className="card">
          <h2 className="text-lg font-semibold text-accent mb-3">Slot Availability</h2>
