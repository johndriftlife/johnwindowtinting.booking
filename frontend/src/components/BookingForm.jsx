  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-3">
        <img src={logo} className="h-48 w-auto mx-auto rounded-xl" alt="logo" />
      ...
      <form className="space-y-4" onSubmit={submit}>
        ...
        <div className="flex items-center justify-between bg-black/40 rounded-xl p-3 border border-accent/30">
          <div className="text-sm text-gray-200">Total: <strong>€{(amount_total/100).toFixed(2)}</strong> • Deposit (50%): <strong>€{(amount_deposit/100).toFixed(2)}</strong></div>
